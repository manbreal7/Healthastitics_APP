...
//    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[][] doctor_details1 = db.getDoctorsBySpecialization("Cardiologist");
        String[][] doctor_details2 = db.getDoctorsBySpecialization("Neurologist");
        String[][] doctor_details3 = db.getDoctorsBySpecialization("Dentist");
        String[][] doctor_details4 = db.getDoctorsBySpecialization("Orthopedic");
        String[][] doctor_details5 = db.getDoctorsBySpecialization("Pediatrician");
        String[][] doctor_details6 = db.getDoctorsBySpecialization("Dermatologist");
